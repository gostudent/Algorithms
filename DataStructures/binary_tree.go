// Code to implement binary search tree in go
//for more information go to wikipedia:https://en.wikipedia.org/wiki/Binary_tree

package binarytree
//no main file,only algorithm for binary tree
// package main
